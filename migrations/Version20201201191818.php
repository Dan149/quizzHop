 ...
 */
final class Version20201201191818 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE question (id INT NOT NULL, quizz_id INT NOT NULL, name VARCHAR(255) NOT NULL, answer BOOLEAN NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_B6F7494EBA934BCD ON question (quizz_id)');
        $this->addSql('CREATE TABLE quizz (id INT NOT NULL, name VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, players INT NOT NULL, PRIMARY KEY(id))');
